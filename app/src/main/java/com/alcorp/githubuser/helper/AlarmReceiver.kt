...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        val title = context.resources.getString(R.string.txt_notif_title)
        val message = context.resources.getString(R.string.txt_notif_message)
    ...
    fun setNotification(context: Context?, time: String){
        ...
        Log.e(ID_REPEATING.toString(), "Time : $time")
    }
